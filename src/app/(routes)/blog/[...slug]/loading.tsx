...
const PostLoading = () => (
  <Shell
    ...
    <div className="flex h-14 w-40 animate-skeleton items-center space-x-2 rounded-md bg-gradient-to-r from-neutral-950 via-neutral-700 to-neutral-950 bg-[400%,100%] text-sm text-muted-foreground" />
    <div className="space-y-4">
      ...
      <div className="flex flex-row items-center justify-start gap-2">
        ...
        <div className="flex flex-col gap-2">
          <div className="h-3 w-40 animate-skeleton bg-gradient-to-r from-neutral-950 via-neutral-700 to-neutral-950 bg-[400%,100%]" />
          <div className="h-3 w-20 animate-skeleton bg-gradient-to-r from-neutral-950 via-neutral-700 to-neutral-950 bg-[400%,100%]" />
        </div>
      </div>
    </div>
