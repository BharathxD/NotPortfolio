...
description: Explore different aspects of designing a social media network, with a focus on key components like CDNs (CDNs), managing bandwidth, optimizing data schema, considering privacy, optimizing images, and understanding how hashtag services work.
date: "2023-10-24"
authors:
  - bharathxd
---
