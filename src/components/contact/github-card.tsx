  ...
  return (
    <motion.a
      ...
      <ImageWithLoader
        ...
        className="absolute inset-x-0 bottom-[-20%] z-10 rounded-xl object-contain grayscale transition-all duration-700 group-hover:grayscale-0 data-[loading=true]:h-[344px] data-[loading=true]:w-[592px] md:inset-x-[auto] md:left-[-20%]"
        height={352}
        width={600}
      />
