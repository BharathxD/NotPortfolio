...
const Hero = () => (
  <motion.h1
    ...
    Hey, I&apos;m <HighlightedSpan>Bharath Lakshman Kumar</HighlightedSpan> (you can call me Bharath, though).
    I&apos;m a <HighlightedSpan>UI Engineer</HighlightedSpan> and a student based in Hyderabad, India.
    I&apos;m working as a software engineering <HighlightedSpan>intern</HighlightedSpan> at Vertocity, where I
