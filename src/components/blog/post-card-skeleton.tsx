...
const PostCardSkeleton = () => (
  <div className="relative flex w-full flex-col gap-4 overflow-hidden rounded-xl border bg-neutral-900/80 p-4">
    ...
    <Skeleton className="z-10 h-5 w-16 rounded-md" />
    <Skeleton className="z-10 h-7 w-[50%] rounded-md md:h-8" />
    <Skeleton className="z-10 h-10 rounded-md" />
    <Skeleton className="z-10 h-5 w-28 rounded-md md:h-6" />
  </div>
);
