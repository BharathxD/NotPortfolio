...
const CardImage = ({ src, alt, className, ...props }: ComponentProps<typeof Image>) => {
  ...
  return (
    <Image
      ...
      className={cn(
        isLoading
          ? "-mb-4 animate-skeleton rounded-lg bg-gradient-to-r from-neutral-950 via-neutral-700 to-neutral-950 bg-[400%,100%]"
          : "z-10 object-contain transition-all duration-700 group-hover:-translate-y-2",
        className
      )}
